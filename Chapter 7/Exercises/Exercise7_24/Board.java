...
public class Board {
    ...
    private int[] getCoordinatesByEliminationNumber(int bestEliminationNumber) {
        ...
        */
        ...
        // Pick a random one from the best candidates (No heuristic approach here, yet!)
        // TODO: Make more heuristic approach to look up and find recursively ( with backtracking ) the best cell to set to the next queen
    ...
    public void setQueen(int queenRow, int queenColumn){
        if(checkPosition(queenRow,queenColumn)){
            ...
            emptyCellsRow(queenRow, queenColumn);
            emptyCellsColumn(queenRow, queenColumn);
    ...
    private void emptyCellsRow(int queenRow, int queenColumn){
    ...
    private void emptyCellsColumn(int queenRow, int queenColumn){
    ...
    private boolean checkIfBoardIsFilled(){
        for(int i = 0; i<8; i++){
            for(int j = 0; j<8; j++){
